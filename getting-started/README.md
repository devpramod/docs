...
### IBM Cloud
If you are deploying it on IBM cloud, select a virtual server from the 3-series instances with base OS as Ubuntu 22.04 under Public Catalog Images. For more information on virtual servers on IBM cloud visit [Intel® solutions on IBM Cloud®](https://www.ibm.com/cloud/intel).
